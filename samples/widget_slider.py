...
fig, ax = plt.subplots()
plt.subplots_adjust(left=0.25, bottom=0.25) # relative values
...
axfreq = plt.axes([0.25, 0.1, 0.65, 0.03], facecolor=axcolor) #relative values, (starting x axl,starting y axl,length,width)
